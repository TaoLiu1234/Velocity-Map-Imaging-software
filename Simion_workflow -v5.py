...
KE_MAX = 3  # Maximum kinetic energy in eV
...
NUM_GROUPS = 100  # Number of particle groups to generate (each group has 8 trajectorr54ies, reduced from v2's 10)
...
#----------------------------------------------------------------------------------------------------------
heatmap_data, lens_values, ke_values = Utilis.heatmap_energy_lens(processed_data, fg=100)
Utilis.plot_heatmap_energy_lens(processed_data, fg=100)
#----------------------------------------------------------------------------------------------------------
